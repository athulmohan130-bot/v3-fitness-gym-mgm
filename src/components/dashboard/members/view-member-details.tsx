        ...
        <div className="lg:col-span-2 space-y-8">
            <Card>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <DetailItem label="Date of Birth" value={format(parseISO(member.dateOfBirth), 'PPP')} />
            ...
            <Card>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <DetailItem label="BMI" value={!isNaN(bmiValue) ? bmiValue.toFixed(1) : 'N/A'} />
                    <DetailItem label="Primary Fitness Goal" value={member.fitnessGoal} />
                     <div className="md:col-span-2">
                        <DetailItem label="Medical Conditions" value={member.medicalConditions.join(', ') || 'None'} />
                     </div>
                </CardContent>
            </Card>
             ...
             <Card>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <DetailItem label="Contact Name" value={member.emergencyContact.name} />
                    <DetailItem label="Contact Phone" value={member.emergencyContact.phone} />
                    <DetailItem label="Relationship" value={member.emergencyContact.relation} />
                </CardContent>
             </Card>
