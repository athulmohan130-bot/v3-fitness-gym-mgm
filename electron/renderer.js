  ...
  eventEl.innerHTML = `
    <div class="event-header">
      <div class="event-user">
        ${data.profileImageUrl ? `<img src="${data.profileImageUrl}" alt="${userName}" style="width: 24px; height: 24px; border-radius: 50%; margin-right: 8px; vertical-align: middle;">` : '👤'}
        ${userName}
      </div>
    ...
    <div class="event-details">
      ...
      ${data.biometricDeviceId ? `<div class="event-detail">🔢 ID: ${data.biometricDeviceId}</div>` : ''}
      <div class="event-detail">${statusBadge}</div>
    </div>
  `;
